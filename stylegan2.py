...
import utils_stylegan.style_misc as misc
from utils_stylegan.style_ops import conv2d_resample
from utils_stylegan.style_ops import upfirdn2d
from utils_stylegan.style_ops import bias_act
from utils_stylegan.style_ops import fma
...
class Discriminator(torch.nn.Module):
    def __init__(
        ...
        self.img_resolution_log2 = int(np.log2(img_resolution))
        self.block_resolutions = [2**i for i in range(self.img_resolution_log2, 2, -1)]  # [256, 128, 64, 32, 16, 8]
        self.MODEL = MODEL
